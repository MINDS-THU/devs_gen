...
export const ABP_INPUT = `general: |
...
export const ABP_INPUT_SECTIONS = splitAbpInputText(ABP_INPUT)

export const ABP_METRIC_FORMULA = `v_i = I(ExitCode=0) * I(NoTimeout) * I(ValidSchema(T_i))
...
export const SA_INPUT_SECTIONS = splitAbpInputText(SA_INPUT)

export const SA_METRIC_FORMULA = `v_i = I(ExitCode=0) * I(NoTimeout) * I(ValidSchema(T_i))
Score_ope = (1/N) * sum_i v_i
...
export const ICU_INPUT = `You are covering a simplified ICU overnight. A patient with suspected sepsis has six hours until the next full team review, and you need to choose the best treatment plan to maximize the patient's condition at the end of that period.
...
export const ICU_DIRECT_CALL_TYPE = `model: GPT-5.4`

export const ICU_ASSIST_CALL_TYPE = `model: GPT-5.4`

export const ICU_DIRECT_OUTPUT_RAW = `1) Final decision
...
export const ICU_ASSIST_OUTPUT_RAW = `1) final decision
Plan 3.
...
export const ICU_SPEC_EXAMPLE = `root_model_name: icu_sepsis_treatment
requirements:
  general: |
...
export const WETLAB_INPUT = `You are running a small biology lab for an 8-hour day (hour 0..8).
...
export const WETLAB_DIRECT_PROMPT_TEMPLATE = `system_prompt = (
...
export const DIRECT_SYSTEM_PROMPT = `You are a careful planning assistant. Solve the task directly without external tools. Be explicit about assumptions and produce a concise but complete answer.`

export const DIRECT_USER_PROMPT_SUFFIX = `Return format:
1) Final decision
2) Key reasoning steps
3) Fragile assumptions
4) Confidence (0-1)`

export const WETLAB_DIRECT_CALL_TYPE = `model: GPT-5.4`

export const WETLAB_ASSIST_CALL_TYPE = `model: GPT-5.4`

export const WETLAB_ASSIST_PROMPT_TEMPLATE = `prompt = (
...
export const WETLAB_DIRECT_OUTPUT_RAW = `1) Final decision
...
export const WETLAB_ASSIST_OUTPUT_RAW = `1) final decision
Strategy B.
...
export const WETLAB_SPEC_PROMPT_TEMPLATE = `system_prompt = (
...
export const WETLAB_SPEC_EXAMPLE = `root_model_name: wet_lab_assay_scheduling
requirements:
  general: |-
...
export const AGENT_WORKFLOW_SYSTEM_PROMPT = `You are an agent for model-based task solving.
...
export const WORKFLOW_DEMO_DATA = {
  wetlab: {
...
export const VISIBLE_CASES = CASES
export const BENCHMARK_CASE_ID = 'sa'
